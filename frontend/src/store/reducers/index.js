...
import productsReducer from '../slices/productSlice'; // Import products reducer
import accountsReducer from '../slices/accountsSlice';
import transactionsReducer from '../slices/transactionsSlice';
import administratorsReducer from '../slices/administratorsSlice'; 

import employeesReducer from '../slices/employeesSlice';
import usersReducer from '../slices/userSlice'; // Import users reducer
...
const rootReducer = combineReducers({
  ...
  accounts: accountsReducer,  // Added accounts slice
