...
/*online order final without pos import { createSlice, createAsyncThunk } from '@reduxjs/toolkit';
import axios from 'axios';
...
export default orderSlice.reducer;pakka but withou pos*/
...
const orderSlice = createSlice({
  ...
  reducers: {
    ...
    setFilterOptions(state, action) {
      state.filterOptions = action.payload; // New reducer for setting filter options
    },
  },
  extraReducers: (builder) => {
    builder
...
export const { clearOrder, setFilterOptions } = orderSlice.actions;
