...
/*  without react slickimport React from 'react';
import '../../assets/styles/Category.css'; // Correct path to Category.css
        ...
        <div className="category-container">
            {categories.map((category, index) => (
                <div key={index} className="category-item text-center">
                    <img src={category.image} alt={category.name} className="img-fluid rounded-circle category-image" />
                    <p>{category.name}</p>
                </div>
            ))}
        </div>
...
/*verticalwiseimport React from 'react';
import '../../assets/styles/Category.css'; // Correct path to Category.css
